            ...
            <div class="card w-full bg-base-100 shadow-sm hover:shadow-xl transition-all duration-300 border border-orange-100 group">
                ...
                <figure class="relative h-52 overflow-hidden">
                    ...
                    <div class="absolute top-3 right-3">
                        <div class="badge bg-orange-500 border-none text-white font-semibold p-3 shadow-md">Good Condition</div>
                    </div>
                </figure>

                <div class="card-body p-5">
                    <div class="flex justify-between items-start">
                        <h2 class="card-title text-gray-800 text-xl font-bold mb-0">Leather Sectional Sofa</h2>
