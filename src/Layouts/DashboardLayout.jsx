                ...
                <div className="drawer-side is-drawer-close:overflow-visible">
                    ...
                    <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                        ...
                        <ul className="menu w-full grow">
                            ...
                            <li>
                                <NavLink to='/'>
                                    <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right space-x-2" data-tip="Homepage">
                                        {/* Home icon */}
                            ...
                            <li>
                                <NavLink to="/dashboard/profile" className="">
                                    <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right items-center gap-2 flex" data-tip="Profile">
                                        {/* Home icon */}
                                        <FaUser />
